...
const OFFSETX_DESC = 140, OFFSETY_DESC = 265;
...
export default class CharacterSelector extends Phaser.GameObjects.Container {
    constructor(scene, x, y, personaje) {
        ...
        if (personaje === 'Shinji') {
            ...
            this.add(this.name);            
            this.add(this.scene.add.text(x - OFFSETX_DESC, y + OFFSETY_DESC, 'Combate a distancia\nIntrovertido\nPoder:\nMantente lejos', styleDescription));
